...
EXCLUDE = re.compile(r'^(Bio ·|Ovan ·|Laura ·|Vittorio ·|Gianluca ·|Nathalie ·)')

L = ["# Annual Summer Party — deck copy", "",
     "Copy for every slide **except** the four presenter bios and their image streams.",
     "Slide numbers match the live deck. The standing running header is omitted; footers",
     "appear as `footer:` where they carry anything of their own.", ""]
